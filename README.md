...
**TKTK: Describe ebola-awards here.**
...
```
* * * * * ubuntu bash /home/ubuntu/apps/ebola_awards/repository/cron.sh fab $DEPLOYMENT_TARGET cron_jobs.test 
```
...
|--------|------|-----|-----|--------|--------|
|ebola-awards|tweet|`location`||||
|ebola-awards|facebook|`location`||||
|ebola-awards|email|`location`||||
|ebola-awards|new-comment||||
|ebola-awards|open-share-discuss||||
|ebola-awards|close-share-discuss||||
|ebola-awards|summary-copied||||
|ebola-awards|featured-tweet-action|`action`||``tweet_url``|
|ebola-awards|featured-facebook-action|`action`||``post_url``|
